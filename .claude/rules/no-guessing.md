...
- For multi-library or high-stakes comparisons, fan out research and adversarially verify each claim (default to "refuted" when no source supports it) rather than asserting from recall.
