...
Canonical definition, read it before editing matching files: [`docs/styles/rules/addressable-variants.md`](../../docs/styles/rules/addressable-variants.md). This file is a Claude Code pointer that auto-loads the rule by path; the full text lives in `docs/`.
