...
- The `--fri-*` token ladder (roles + slots) is hand-authored in `packages/styles/themes/default/variables.css`; the five surfaces and the react/styles split: `CLAUDE.md` → Architecture, `button.css`.
