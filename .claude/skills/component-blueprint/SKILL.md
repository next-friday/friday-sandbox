...
- Optional sub-agent: have a reviewer pressure-test the premise, ladder, and plan for gaps — a missing state, an ambiguous variant, an unprovable Done — before any build.
