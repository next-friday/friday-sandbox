...
Enforce [`component-structure.md`](../.claude/rules/component-structure.md) and [`compose-and-dry.md`](../.claude/rules/compose-and-dry.md). Key checks:
...
Enforce [`accessibility-and-stories.md`](../.claude/rules/accessibility-and-stories.md). Key checks:
...
Enforce [`canonical-tailwind.md`](../.claude/rules/canonical-tailwind.md) and [`semantic-token-scope.md`](../.claude/rules/semantic-token-scope.md). Key checks:
