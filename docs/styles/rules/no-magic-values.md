...
- Unitless multipliers such as `--scroll-area-n: 2.5` or `--action-n: 10` are configuration, not magic: they are fine as local vars because the _unit_ they multiply is a token.
